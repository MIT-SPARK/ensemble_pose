...
PROJECT_ROOT = Path(cosypose.__file__).parent.parent.parent
PROJECT_DIR = PROJECT_ROOT
DATA_DIR = PROJECT_DIR / 'data'
LOCAL_DATA_DIR = PROJECT_DIR / 'data' / 'bop'
...
#cfg = yaml.load((PROJECT_DIR / 'src' / 'cosypose' / 'config_yann.yaml').read_text(), Loader=yaml.FullLoader)
#
