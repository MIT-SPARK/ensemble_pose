...
"""
#ToDo: Update this code to use pace_altern_ddn and correct modelgen files.
...
from src.datasets.shapenet import SE3nAnisotropicScalingPointCloud, ScaleAxis
from src.datasets.shapenet import PCD_FOLDER_NAME as KEYPOINTNET_PCD_FOLDER_NAME
from src.utils.visualization_utils import display_two_pcs
