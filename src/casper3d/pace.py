"""
#ToDo: Take this code out. Use pace_altern_ddn.py. Implement backprop at pace_altern_ddn.py.
...
from casper3d.sdp import RotationSDP
from utils.evaluation_metrics import shape_error, translation_error, rotation_matrix_error
from utils.general import generate_random_keypoints

# from src.datasets.shapenet import CLASS_NAME, CLASS_ID
