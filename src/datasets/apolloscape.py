...
sys.path.append("../")
sys.path.append(os.path.join(os.path.dirname(sys.path[0]), '../casper3d', 'third_party', 'apolloscape', 'dataset-api'))
sys.path.append(os.path.join(os.path.dirname(sys.path[0]), '../casper3d', 'third_party', 'apolloscape', 'dataset-api', 'utils'))
sys.path.append(os.path.join(os.path.dirname(sys.path[0]), '../casper3d', 'third_party', 'apolloscape', 'car_averaging'))
from car_instance.car_models import *


from casper3d.modelgen_apolloscape import ModelFromShapeApolloModule
from utils.general import pos_tensor_to_o3d
from utils.visualization_utils import visualize_model_n_keypoints
